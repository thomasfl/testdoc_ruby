# testdoc - Generer testplandokumenter fra watir, celerity eller lignende.
#
...
require 'erb'
require 'testdocoptions'
require 'testdocparser'


VERSION_STRING = %{TestDoc V0.1.0 - 20080721}
  ...
  class TestDoc
    ...
    def document(argv)
      ...
      if(options.text) then
        template_file = "template.debug.erb"
      end
